...
@Generated("")
@OpenAPIDefinition(
	info = @Info(license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "AiCert API", version = "v1.0")
)
@Path("/v1.0")
public class OpenAPIResourceImpl {
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			add(AiAskResponseResourceImpl.class);
