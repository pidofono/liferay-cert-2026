 ...
 */
@Generated("")
@GraphQLName("AiAskRequest")
@io.swagger.v3.oas.annotations.media.Schema(requiredProperties = {"question"})
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "AiAskRequest")
public class AiAskRequest implements Serializable {

	public static AiAskRequest toDTO(String json) {
		return ObjectMapperUtil.readValue(AiAskRequest.class, json);
	}

	public static AiAskRequest unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(AiAskRequest.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferaycert.ai.dto.v1_0.AiAskRequest",
		name = "x-class-name"
	)
